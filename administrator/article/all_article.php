...
include(  __ROOT__.'/administrator/article/article_opt_view/article_opt_view.php' );
echo  "</td>";
/* Option View Article
=======================*/
...
/* Option Cest Article*/
echo "<td style=\"text-align:center;\">";
include(  __ROOT__.'/administrator/article/article_opt_cest/article_opt_cest.php' );
echo  "</td>";
/* Option Cest Article
=======================*/
...
/* Option Arch Article*/
echo "<td style=\"text-align:center;\">";
include(  __ROOT__.'/administrator/article/article_opt_arch/article_opt_arch.php' );
echo "</td>";
/* Option Arch Article
=======================*/
...
?>
<?php include(  __ROOT__.'/administrator/article/pagin/pagination.php' ); ?>
